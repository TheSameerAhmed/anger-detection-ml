...
```{r}
data <- read.csv("./extracted/preprocessed_data_full.csv", header = TRUE, colClasses = c("numeric", "numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric","numeric", "factor", "factor"))
```
